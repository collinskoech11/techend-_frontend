...
export interface LiquidEtherProps<PropsWithChildren> {
  mouseForce?: number;
  cursorSize?: number;
  isViscous?: boolean;
  viscous?: number;
...
export default function LiquidEther({
  ...
  children
}: LiquidEtherProps<PropsWithChildren>): React.ReactElement {
...
`;
  ...
  return <div ref={mountRef} className={`liquid-ether-container ${className || ''}`} style={style} >{children}</div>;
}
